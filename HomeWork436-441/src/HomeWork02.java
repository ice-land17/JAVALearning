...
class TestFrock {
    public static void main(String[] args) {
        System.out.println(Frock.getNextNum());//10100
        System.out.println(Frock.getNextNum());//10200
        Frock frock = new Frock();//10300
        Frock frock1 = new Frock();//10400
        Frock frock2 = new Frock();//10500
